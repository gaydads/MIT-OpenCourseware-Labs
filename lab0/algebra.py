...
def do_multiply(expr1, expr2):
	...
	* expr1 is a Product, and expr2 is a Product
	...
	# expr1 is a Product, and expr2 is a Product
	if (isinstance(expr1, Product) & isinstance(expr2, Product)):
		print ('found path 1')
		return Product(expr1 + expr2)
	# expr1 is a Product, and expr2 is a Sum
	elif (isinstance(expr1, Product) & isinstance(expr2, Sum)):
		distribute = []
		for item in expr2:
			distribute.append(Product([item] + expr1))
			# print('item in sum: ', item)
		return Sum(distribute)
	# expr1 is a Sum, and expr2 is a Product
	elif (isinstance(expr1, Sum) & isinstance(expr2, Product)):
		distribute = []
		for item in expr1:
			distribute.append(Product([item] + expr2))
			# print('item in sum: ', item)
		return Sum(distribute)
	# expr1 is a Sum, and expr2 is a Sum
	else:
		...
		for item1 in expr1:
			for item2 in expr2:
				distribute.append(Product([item1] + [item2]))
		return Sum(distribute)